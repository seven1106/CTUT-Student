...
class CourseAdapter : RecyclerView.Adapter<CourseAdapter.CourseViewHolder>() {
    inner class CourseViewHolder(private val binding: CourseRvItemBinding) :
    ...
    override fun onBindViewHolder(holder: CourseViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<android.widget.ImageView>(com.example.ctut_student.R.id.ibDeleteUser)
            .setOnClickListener {
